        ...
        <form className="m-4">
            <div className="form-row">
                <div className="col-md-12 mb-3">
                    ...
                    <input type="text" className="form-control" id="validationDefault01" placeholder="Ex: Fabio" value="" required/>
                </div>
            <div className="col-md-12 mb-3">
                <label for="validationDefault02">Last name</label>
                <input type="text" className="form-control" id="validationDefault02" placeholder="Ex: Valentim" value="" required/>
            </div>
            ...
            <div className="col-md-12 mb-3">
                <label for="validationDefaultUsername">Instagram</label>
                    <div className="input-group">
                        ...
                        <input type="text" className="form-control" id="validationDefaultUsername" placeholder="your Instagram" aria-describedby="inputGroupPrepend2" required/>
                    </div>
                </div>
            </div>
